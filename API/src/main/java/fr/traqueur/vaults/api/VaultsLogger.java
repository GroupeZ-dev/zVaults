...
public class VaultsLogger {
    ...
    static {
        LOGGER = JavaPlugin.getPlugin(VaultsPlugin.class).getLogger();
        colorFormatter = '&';
    }

    public static void info(String message) {
        VaultsLogger.log(Level.INFO, message);
    }

    public static void success(String message) {
        VaultsLogger.log(Level.INFO, "&a" + message);
    }

    public static void severe(String message) {
        VaultsLogger.log(Level.SEVERE, "&c" + message);
    }

    public static void warning(String message) {
        VaultsLogger.log(Level.WARNING, "&e" + message);}
