...
public enum Message {
    ...
    NO_REQUIREMENT_MESSAGE, MAX_VAULTS_REACHED, VAULT_CREATED, RECEIVE_NEW_VAULT, SIZE_NOT_AVAILABLE, VAULT_GROWED, VAULT_GROWED_SUCCESS, VAULT_NOT_FOUND, VAULT_SET_SIZE, VAULT_SET_SIZE_SUCCESS, NOT_PERMISSION_CONFIGURE_VAULT;
