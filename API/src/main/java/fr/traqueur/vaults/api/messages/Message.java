...
public enum Message {
    ...
    VAULT_ICON_CHANGE,
    VAULT_DELETED,
    RELOAD_PLUGIN_SUCCESS,
    SET_SIZE_COMMAND_DESCRIPTION,
    OPEN_COMMAND_DESCRIPTION,
    GROW_SIZE_COMMAND_DESCRIPTION,
    CREATE_COMMAND_DESCRIPTION,
    STACKLIMIT_COMMAND_DESCRIPTION,
    VAULT_NOT_INFINITE,
    STACKLIMIT_SET,
    CONVERT_COMMAND_DESCRIPTION,
    PLUGIN_TO_CONVERT_NOT_ENABLE,
    CONVERT_COMMAND_SUCCESS,
    VAULT_NAME_ALREADY_SET,
    VAULT_NAME_CHANGED, ADDSTACKLIMIT_COMMAND_DESCRIPTION, STACKLIMIT_ADD, BIND_COMMAND_DESCRIPTION, USER_NOT_OWNER, VAULT_ID_ALREADY_EXISTS, VAULT_BIND, VAULT_NO_ACCESS;
