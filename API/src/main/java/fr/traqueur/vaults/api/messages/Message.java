...
public enum Message {
    ...
    SUCCESSFULLY_REMOVED_ACCESS_TO_VAULT, ITEM_CANT_BE_NULL, VAULT_ICON_CHANGE, VAULT_DELETED, RELOAD_PLUGIN_SUCCESS, SET_SIZE_COMMAND_DESCRIPTION, OPEN_COMMAND_DESCRIPTION, GROW_SIZE_COMMAND_DESCRIPTION, CREATE_COMMAND_DESCRIPTION, STACKLIMIT_COMMAND_DESCRIPTION, VAULT_NOT_INFINITE, STACKLIMIT_SET, CONVERT_COMMAND_DESCRIPTION, PLUGIN_TO_CONVERT_NOT_ENABLE, CONVERT_COMMAND_SUCCESS;
